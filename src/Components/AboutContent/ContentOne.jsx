...
const ContentOne = () => {
  ...
  return (
    ...
    <div className='bg-content h-[45vh]'></div>
      <div className="font-custom lg:text-2xl text-center p-5 lg:p-20 leading-8 lg:leading-10">
        <span className='bg-neutral-50 px-2 rounded-lg shadow-lg shadow-stone-400 text-black'>
          Verve Decor</span> si brand të veçantë nga Grand Decor e kemi krijuar në vitin 2020. Kërkesa e 
