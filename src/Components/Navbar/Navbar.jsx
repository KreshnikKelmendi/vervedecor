...
const Navbar = () => {
  ...
  return (
    <>
      <div className="w-full py-3 lg:py-0 text-[10px] lg:text-[12px] text-center h-12 items-center justify-between px-6 flex flex-col lg:flex-row bg-[#E8AAAD] uppercase font-bold text-white">
