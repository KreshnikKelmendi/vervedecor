...
const ThirdAbout = () => {
  return (
    <div className='w-full mt-6 py-6 lg:mt-16 relative'>
      ...
      />
      <div className="absolute top-1/2 left-1/2 transform w-full lg:w-1/2 -translate-x-1/2 -translate-y-1/2 text-center bg-opacity-70 bg-white hover:bg-red-100 p-4 rounded-md">
