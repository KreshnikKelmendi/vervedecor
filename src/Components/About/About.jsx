...
const About = () => {
  return (
    ...
    <div className='text-3xl my-5 text-center font-custom1 justify-center align-center'>
         <h3 className='p-1 lg:p-0'>Zbukuroni ngjarjet e rëndësishme në jetën tuaj!</h3>
    </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-16 text-center justify-center font-custom1 p-4">
